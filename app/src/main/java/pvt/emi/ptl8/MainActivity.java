...
import pvt.emi.ptl8.auth.LoginActivity;
import pvt.emi.ptl8.main.HelloActivity;
...
public class MainActivity extends AppCompatActivity implements
  ...
  protected void onCreate(Bundle savedInstanceState) {
   ...
   // getSupportActionBar().setIcon(R.drawable.ic_talinor_logo); //also displays wide logo
